...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def _forward_model(self, batch_x, is_training):
    ...
    def vali(self, vali_data, vali_loader, criterion):
        ...
        with torch.no_grad():
            for batch_x, batch_y, batch_x_mark, batch_y_mark in vali_loader:
                ...
                outputs, moe_loss = self._forward_model(batch_x, is_training=False)
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for batch_index, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(train_loader):
                ...
                outputs, moe_loss = self._forward_model(batch_x, is_training=True)
                outputs, batch_y = self._slice_prediction(outputs, batch_y)
                loss = criterion(outputs, batch_y) + 0.05 * moe_loss
    ...
    def test(self, setting, test=0):
        ...
        with torch.no_grad():
            for batch_index, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(test_loader):
                ...
                outputs, _ = self._forward_model(batch_x, is_training=False)
                outputs, batch_y = self._slice_prediction(outputs, batch_y)
